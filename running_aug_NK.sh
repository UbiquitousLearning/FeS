...
# # label no random
nohup python sweep_aug.py --dataset agnews --device 4 --train_examples 64 --test_examples -1 --unlabeled_examples -1 --method fedpet --client_num_in_total 32 --all_client_num_in_total 1000 --alpha 1 --gamma 0.001 --pattern_ids 1 --data_point 1 --num_clients_infer 5 --infer_freq 1 --model_name_or_path roberta-base &

nohup python sweep_aug.py --dataset agnews --device 4 --train_examples 0 --test_examples -1 --unlabeled_examples -1 --method fedpet --client_num_in_total 32 --all_client_num_in_total 1000 --alpha 1 --gamma 0.001 --pattern_ids 1 --data_point 1 --num_clients_infer 5 --infer_freq 1 --model_name_or_path roberta-base &
...
nohup python sweep_aug.py --dataset agnews --device 7 --train_examples 0 --test_examples -1 --unlabeled_examples -1 --method fedpet --client_num_in_total 32 --all_client_num_in_total 1000 --alpha 1 --gamma 0.001 --pattern_ids 1 --data_point 4 --num_clients_infer 5 --infer_freq 2 --model_name_or_path roberta-base &

nohup python sweep_aug.py --dataset agnews --device 7 --train_examples 0 --test_examples -1 --unlabeled_examples -1 --method fedpet --client_num_in_total 32 --all_client_num_in_total 1000 --alpha 1 --gamma 0.001 --pattern_ids 1 --data_point 4 --num_clients_infer 10 --infer_freq 2 --model_name_or_path roberta-base &

nohup python sweep_aug.py --dataset agnews --device 7 --train_examples 0 --test_examples -1 --unlabeled_examples -1 --method fedpet --client_num_in_total 32 --all_client_num_in_total 1000 --alpha 1 --gamma 0.001 --pattern_ids 1 --data_point 4 --num_clients_infer 15 --infer_freq 2 --model_name_or_path roberta-base &

nohup python sweep_aug.py --dataset agnews --device 7 --train_examples 0 --test_examples -1 --unlabeled_examples -1 --method fedpet --client_num_in_total 32 --all_client_num_in_total 1000 --alpha 1 --gamma 0.001 --pattern_ids 1 --data_point 4 --num_clients_infer 20 --infer_freq 2 --model_name_or_path roberta-base &

nohup python sweep_aug.py --dataset agnews --device 7 --train_examples 0 --test_examples -1 --unlabeled_examples -1 --method fedpet --client_num_in_total 32 --all_client_num_in_total 1000 --alpha 1 --gamma 0.001 --pattern_ids 1 --data_point 8 --num_clients_infer 5 --infer_freq 2 --model_name_or_path roberta-base &

nohup python sweep_aug.py --dataset agnews --device 7 --train_examples 0 --test_examples -1 --unlabeled_examples -1 --method fedpet --client_num_in_total 32 --all_client_num_in_total 1000 --alpha 1 --gamma 0.001 --pattern_ids 1 --data_point 8 --num_clients_infer 10 --infer_freq 2 --model_name_or_path roberta-base &

nohup python sweep_aug.py --dataset agnews --device 7 --train_examples 0 --test_examples -1 --unlabeled_examples -1 --method fedpet --client_num_in_total 32 --all_client_num_in_total 1000 --alpha 1 --gamma 0.001 --pattern_ids 1 --data_point 8 --num_clients_infer 15 --infer_freq 2 --model_name_or_path roberta-base &

nohup python sweep_aug.py --dataset agnews --device 7 --train_examples 0 --test_examples -1 --unlabeled_examples -1 --method fedpet --client_num_in_total 32 --all_client_num_in_total 1000 --alpha 1 --gamma 0.001 --pattern_ids 1 --data_point 8 --num_clients_infer 20 --infer_freq 2 --model_name_or_path roberta-base &
