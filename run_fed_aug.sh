...
rm -rf $output_model_dir/new_sort_stale_aug_${data_point}_conver_${conver_point}_limit_${limit}_${method}_${train_examples}_${clients}_${model_name_or_path}_${num_clients_infer}_${infer_freq}_filter_${filter}
...
--task_name ${task_name} \
--output_dir $output_model_dir/new_sort_stale_aug_${data_point}_conver_${conver_point}_limit_${limit}_${method}_${train_examples}_${clients}_${model_name_or_path}_${num_clients_infer}_${infer_freq}_filter_${filter} \
--ipet_scale_factor 1 \
...
--vote_k ${filter} \
--aggregated > ${output_log_dir}/new_sort_stale_aug_${data_point}_conver_${conver_point}_limit_${limit}_${method}_${train_examples}_${clients}_${model_name_or_path}_${num_clients_infer}_${infer_freq}_filter_${filter}.log 2>&1
