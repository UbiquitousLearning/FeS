...
--task_name ${task_name} \
--output_dir $output_model_dir/aug_${method}_${train_examples}_${clients}_${model_name_or_path} \
--ipet_scale_factor 1 \
...
--augmentation \
--seed ${seed} \
--aggregated > ${output_log_dir}/aug_${method}_${train_examples}_${clients}_${model_name_or_path}.log 2>&1
