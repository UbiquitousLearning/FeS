...
nohup python sweep_aug.py --dataset mnli --device 1 --train_examples 0 --test_examples -1 --unlabeled_examples -1 --method fedpet --client_num_in_total 32 --all_client_num_in_total 1000 --seed ${seed} --pattern_ids 0 --gamma ${gamma} --alpha 1 --data_point 20 --conver_point 10 --limit 0 &

nohup python sweep_aug.py --dataset yahoo --device 2 --train_examples 0 --test_examples -1 --unlabeled_examples -1 --method fedpet --client_num_in_total 32 --all_client_num_in_total 1000 --seed ${seed} --pattern_ids 0 --gamma ${gamma} --alpha 1 --data_point 20 --conver_point 1 --limit 0 &

nohup python sweep_aug.py --dataset yelp-full --device 3 --train_examples 0 --test_examples -1 --unlabeled_examples -1 --method fedpet --client_num_in_total 32 --all_client_num_in_total 1000 --seed ${seed} --pattern_ids 0 --gamma ${gamma} --alpha 1 --data_point 20 --conver_point 3 --limit 0 &
